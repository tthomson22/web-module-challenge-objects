...
const item2 = createMenuItem('Donut', 2, 'Breakfast');
const item3 = createMenuItem('Burger', 8, 'Dinner');
console.log(item1);
console.log(item2);
console.log(item3);
...
Write a function that creates an object with name, rating, feedback, add the new review to the end of an array and returns the resulting array
 the addReview function below to do the following:
  ...
  3. The function should push the following object to the array: {name: 'Daniela', rating: 5, review: 'array.push({name: 'Daniela', rating: 5, review: 'Beautiful atmosphere and wonderful vegan options!'});' }
